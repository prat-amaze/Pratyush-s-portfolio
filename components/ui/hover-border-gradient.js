...
export function HoverBorderGradient({
  children,
  containerClassName, // set fixed width and height
  className,
  as: Tag = "button",
  duration = 1,
  clockwise = true,
  ...
  return (
    <Tag
      ...
      {...props}>
      <div
        className={cn("w-full h-full z-10 bg-black rounded-full overflow-hidden flex items-center justify-center", className)}>
        {children}
      </div>
      <motion.div
